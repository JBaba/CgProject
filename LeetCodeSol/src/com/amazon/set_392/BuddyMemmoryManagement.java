...
public class BuddyMemmoryManagement extends java.util.Observable {
     ...
     * @param maxMemorySize
     */
    public BuddyMemmoryManagement(long minMemorySize, long maxMemorySize) {
    ...
    public int findClosestPowerOf2(long processSize) {
