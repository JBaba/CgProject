...
public class DrawPentagonUsingOpenGL extends JFrame implements GLEventListener {
	...
	public DrawPentagonUsingOpenGL() {
	...
	public static void main(String[] args) {
		DrawPentagonUsingOpenGL demo = new DrawPentagonUsingOpenGL();
