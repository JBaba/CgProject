...
public class Picture extends Group {
    ...
    public void createSceneGraph() throws Exception {
        ...
        BufferedImage imgpic = ImageIO.read(new File("C:\\Data\\EWorkspace\\CgProject\\src\\inter\\kitchen\\picture.jpg"));
        TextureLoader loaderPic = new TextureLoader(imgpic);
        ...
        // Set the texture
        pictureAppearance.setTexture(loaderPic.getTexture());
     ...
     * @throws Exception 
     */
    public Picture(String imageURL) throws Exception {
